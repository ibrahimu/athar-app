...
let specs: [Spec] = [
    ...
    .init(file: "12", shots: ["22-live.png", "21-radio.png"], title: "بثّ الحرمين وإذاعة القرآن مباشرة",
          ...
          features: [.init(icon: "dot.radiowaves.left.and.right", text: "بثّ رسمي متواصل على مدار اليوم"), .init(icon: "lock.fill", text: "يستمر في الخلفية وعلى شاشة القفل"),
                     .init(icon: "radio.fill", text: "الإذاعة قسم مستقل وبطاقة في «اليوم»"), .init(icon: "rectangle.on.rectangle", text: "مكة والمدينة في شاشة واحدة")],
          c1: Color(red: 0.08, green: 0.30, blue: 0.40), c2: Color(red: 0.14, green: 0.44, blue: 0.56)),
    .init(file: "13", shots: ["23-phrases.png", "24-settings-font.png"], title: "بطاقات صور تصمّمها بنفسك",
          subtitle: "تهانٍ للعيدين ورمضان واليوم الوطني: اختر الشكل واللون والنقش والخط، أو اكتب نصّك",
          features: [.init(icon: "text.quote", text: "94 نصًّا: الجمعة والصباح والمساء والمناسبات"), .init(icon: "paintpalette.fill", text: "12 لونًا و6 نقوش و3 أشكال وتوقيعك"),
    ...
    .init(file: "14", shots: ["25-mushaf-fit.png", "26-onboarding.png"], title: "الصفحة كاملة على الشاشة",
          subtitle: "الصفحة كلها بلا تمرير، والآية المختارة كتلة واحدة، وترحيب من خمس خطوات",
