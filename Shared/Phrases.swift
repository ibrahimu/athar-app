...
enum PhraseLibrary {
    ...
    static let all: [Phrase] = [
        ...
        // r1158 لا r1399: المتن واحد، وفي r1399 زيادة سؤالٍ وجواب وتصحيف «بلىت» — كلاهما يثقل بطاقة.
        hadith("r1158", .friday),          // إن من أفضل أيامكم يوم الجمعة فأكثروا فيه من الصلاة عليّ
        ...
        // r1155 لا r1154: كلاهما في الغسل والتبكير، ولفظ r1155 مرتَّبٌ بالساعات فيُقرأ وحده تامًّا.
        hadith("r1155", .friday),          // من اغتسل يوم الجمعة ثم راح في الساعة الأولى
        dhikr("sl01", .friday),            // الصلاة الإبراهيمية
        dhikr("sl02", .friday),            // اللهم صلّ وسلّم على نبيّنا محمد
        // الحديث وآيته متجاوران: البطاقة تذكّر بعشر الكهف، والآية العاشرة آخرهنّ.
        hadith("r1021", .friday),          // من حفظ عشر آيات من أول سورة الكهف
        ayah(18, 10, .friday),
        plain(1, "جمعة مباركة، تقبّل الله منا ومنكم صالح الأعمال", .friday),
        plain(2, "جمعة طيّبة، أكثروا فيها من الصلاة على النبي ﷺ", .friday),
        plain(3, "جمعة مباركة، أسعد الله أيامكم وبارك في أعماركم", .friday),
        plain(4, "لا تنسونا من دعائكم في ساعة الإجابة — جمعة مباركة", .friday),
        plain(5, "أسأل الله أن يتقبّل منكم، وأن يجعل جمعتكم خيرًا وبركة", .friday),
