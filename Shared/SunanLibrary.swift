...
struct SunnahPrayer: Identifiable, Hashable {
    ...
    let id: String
    let title: String
    /// «2» أو «2 أو 4» — نصّ العدد كما يُعرض.
    let rakaat: String
    let timing: Timing
...
enum SunanLibrary {
    ...
    static let rawatib: [SunnahPrayer] = [
        .init(id: "fajr-before", title: "سنّة الفجر", rakaat: "2", timing: .before(.fajr), emphasis: .muakkadah,
              ...
              icon: "sunrise.fill"),
        .init(id: "dhuhr-before", title: "سنّة الظهر القبلية", rakaat: "4", timing: .before(.dhuhr), emphasis: .muakkadah,
              ...
              icon: "sun.max.fill"),
        .init(id: "dhuhr-after", title: "سنّة الظهر البعدية", rakaat: "2", timing: .after(.dhuhr), emphasis: .muakkadah,
              detail: "ركعتان بعد الفريضة، وهما من الرواتب التي داوم عليها النبي ﷺ في الحضر.",
              evidence: [twelveHadith], icon: "sun.max.fill"),
        .init(id: "maghrib-after", title: "سنّة المغرب", rakaat: "2", timing: .after(.maghrib), emphasis: .muakkadah,
        ...
        .init(id: "isha-after", title: "سنّة العشاء", rakaat: "2", timing: .after(.isha), emphasis: .muakkadah,
              detail: "ركعتان بعد العشاء، ثم ما شاء من قيام الليل، ويختم بالوتر.",
              evidence: [twelveHadith], icon: "moon.stars.fill"),
        .init(id: "asr-before", title: "قبل العصر", rakaat: "4", timing: .before(.asr), emphasis: .mustahabbah,
              ...
              icon: "sun.min.fill"),
        .init(id: "maghrib-before", title: "قبل المغرب", rakaat: "2", timing: .before(.maghrib), emphasis: .mustahabbah,
              ...
              icon: "sunset.fill"),
        .init(id: "isha-before", title: "قبل العشاء", rakaat: "2", timing: .before(.isha), emphasis: .mustahabbah,
    ...
    static let others: [SunnahPrayer] = [
        .init(id: "witr", title: "الوتر", rakaat: "1 – 11", timing: .other, emphasis: .muakkadah,
              ...
              icon: "moon.fill"),
        .init(id: "duha", title: "صلاة الضحى", rakaat: "2 – 8", timing: .other, emphasis: .mustahabbah,
              ...
              icon: "sun.haze.fill"),
        .init(id: "tahiyyah", title: "تحيّة المسجد", rakaat: "2", timing: .other, emphasis: .mustahabbah,
        ...
        .init(id: "wudu", title: "سنّة الوضوء", rakaat: "2", timing: .other, emphasis: .mustahabbah,
