...
enum AppTab: String, CaseIterable, Identifiable, Codable {
    ...
    case home, mushaf, adhkar, prayer, live, radio, tasbih, hajj, qibla, hifz, recitation,
         khatmah, wird, hadith, phrases, names, ahkam, prayerLog, calendar, zakat, wallet, sunan, friday, ramadan, settings
    ...
    var group: Group {
        ...
        case .prayer, .live, .radio, .qibla, .prayerLog, .hajj, .sunan, .friday, .ramadan: return .worship
    ...
    var blurb: String {
        ...
        case .ramadan:    return loc("إمساكية الشهر وقضاء الصيام وقراءات القيام")
