    ...
    private var alerts: some View {
        VStack(spacing: 8) {
            ...
            SettingsCard {
                ...
                // مطفأ افتراضيًا: النشاط الحيّ لا يُسكته وضعُ التركيز، فمن وضع «عدم الإزعاج»
                // كان يرى «حان الوقت» على الجزيرة رغمًا عنه. فلا يُوضع فيهما شيء حتى يُطلب.
                SettingsRow(icon: "timer", tint: Theme.accent(for: "sea"),
                            title: loc("النشاط الحيّ"),
                            subtitle: loc("عدّ الصلاة القادمة على شاشة القفل والجزيرة قبل الأذان بنصف ساعة — مطفأ حتى تُشغّله")) {
                    Toggle("", isOn: Binding(
