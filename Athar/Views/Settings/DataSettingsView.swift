...
struct DataSettingsView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(loc("هل تريد تصفير كل الإحصائيات؟"), isPresented: $showResetConfirm, titleVisibility: .visible) {
            ...
            // ما يُمحى يُعدّ بأسمائه التي يعرفها صاحبه: التصفير يتعدّى العدّادات إلى
            // سجلّ الصلاة والفوائت، وهما لا يُعرضان في هذه الصفحة فلا يخطران بباله.
            Text(loc("يُمحى: العدّادات والتتابع وجلسات الأذكار، وسجلّ الصلاة، وعدد الفوائت. ولا رجوع فيه."))
        }
